...
<body>
	<ul class="nav nav-tabs">
      ...
      <li class="nav-item">
	    <a class="nav-link active" href="../oderdetal/tongdon.php">Tổng doanh thu</a>
	  </li>
	</ul>
	<div class="container">
...
$sql= "select * from ((order_details inner join products on products.id= order_details.product_id ) inner join orders on orders.id= order_details.order_id) ";
